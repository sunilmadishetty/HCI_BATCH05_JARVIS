...
//Other educational commands
    ...
    if(transcript.includes("Tell me about yourself")){
        readOut("My name is Jarvis and I was create by Sunil. I am programmed to assist you in completing various tasks and make your life easier")
    }
    if(transcript.includes("Who are you")){
        readOut("My name is Jarvis and I was create by Sunil. I am programmed to assist you in completing various tasks and make your life easier")
    }
    if(transcript.includes("Why are you like this")){
        readOut("A certain person named sunil programmed me like this and here I am")
    }
